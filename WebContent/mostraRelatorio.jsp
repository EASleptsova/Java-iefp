...
try{
	...
	<% }else{%>
		<img src="resources/imgs/default.png" height="200" width="200"/>
	<%}	
	Statement comando1=ligacao.createStatement();
	ResultSet rst1=comando1.executeQuery("select * from report where idKid="+id+" order by id desc limit 1");
	rst1.next();	
	%></p>

<table id="report" align="center" style="width:700px">
<tr><th></th>
...
<td style="white-space:pre-wrap; word-wrap:break-word" > <%= rst1.getString("notes") %></td></tr>
</table>
<br>
...
<%}catch(Exception e){
out.print("<p>***Não há relatórios para mostrar***</p>");}%>
</body>
</html>
